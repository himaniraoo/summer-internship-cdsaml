        ...
        for class_name in self.classes:
            ...
            for file in os.listdir(class_path):
                if file.endswith('.npy'):
                    ...
                    # ✅ Extract subject/group: e.g., gesture_subjectID_rest.npy
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(logo.split(indices, groups=groups)):
        ...
        print(f"\n===== Fold {fold+1} | Leaving out subject(s): {left_out_subjects} =====")
    ...
    print(f"\nMean LOSO Acc: {mean_acc:.4f} ± {std_acc:.4f}")
    print(f"Mean LOSO F1: {mean_f1:.4f} ± {std_f1:.4f}")
    ...
    print("\n✅ Saved: Confusion Matrix and Report (LOSO) ✅")
    ...
    }, "final_focal_gru2_loso_model.pth")

    print("\n✅ Final LOSO model saved as final_focal_gru2_loso_model.pth ✅")
